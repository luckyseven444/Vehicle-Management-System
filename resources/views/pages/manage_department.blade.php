                        ...
                        <table class="table">
                            ...
                            @foreach($departments as $department)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('department/update-department?department_id='.$department->id)}}" class="md-btn md-raised m-b-sm w-xs indigo">
                    <span>Edit
                    </span>
                                        </a>
                                        <a href="{{url('department/delete-department?department_id='.$department->id)}}" class="md-btn md-raised m-b-sm w-xs indigo"
